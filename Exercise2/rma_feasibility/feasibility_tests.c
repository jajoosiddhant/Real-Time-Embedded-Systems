/*
 * 
 * Filename: RMA feasibility test
 * Author: Siddhant Jajoo
 * Description: This code finds out if the given task set is feasible under Rate Monotonic Analysis protocol.
 * Date: 02/21/2019.
 * References:Real time Embedded Systems-Sam Siewert and John Pratt. 
 */
